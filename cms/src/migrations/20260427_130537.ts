...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TYPE "public"."enum_posts_tag" AS ENUM('milestone', 'craft', 'progress', 'people', 'press', 'timelapse', 'market');
  CREATE TYPE "public"."enum_posts_status" AS ENUM('draft', 'published');
  CREATE TYPE "public"."enum__posts_v_version_tag" AS ENUM('milestone', 'craft', 'progress', 'people', 'press', 'timelapse', 'market');
  CREATE TYPE "public"."enum__posts_v_version_status" AS ENUM('draft', 'published');
  CREATE TYPE "public"."enum__posts_v_published_locale" AS ENUM('en', 'ro');
  CREATE TYPE "public"."enum_authors_socials_platform" AS ENUM('linkedin', 'instagram', 'twitter', 'website');
  CREATE TABLE "posts" (
