  ...
  build: {
    rollupOptions: {
      input: {
        ...
        roPrivacy: resolve(__dirname, 'ro/privacy.html'),
        roTerms: resolve(__dirname, 'ro/terms.html'),
        roCookies: resolve(__dirname, 'ro/cookies.html'),
        roLegal: resolve(__dirname, 'ro/legal.html'),
        ...mediaInputs(),
      },
    },
  },
